...
合计: **941,126** 行代码（覆盖前 5 种语言、共 **4742** 个文件）。
...
- **Star**: 2,049 · **Fork**: 689 · **开放 issue**: 0 · **贡献者**: 309

## 累计统计

- **发布数**: 182 · **已合并 PR**: 14946 · **开放 PR**: 221 · **已关闭 issue**: 0 · **开放 issue**: 0 · **提交数**: 63609
...
在 [repology.org](https://repology.org/project/snapd) 上共有 **82** 个发行版报告此项目。**8** 个 ✅ 已是最新上游版本，**59** 个 ⚠️ 使用旧版本。
...
_数据快照: `data/card/260911.yml` · 2026-09-11T20:33:22Z._
